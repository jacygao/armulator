...
namespace LoadBalancerController
{
    using System = global::System;

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public interface ILoadBalancersController
    {
        ...
        System.Threading.Tasks.Task DeleteAsync(string resourceGroupName, string loadBalancerName, string api_version, string subscriptionId);
        ...
        /// <returns>Request successful. The operation returns the resulting LoadBalancer resource.</returns>

        System.Threading.Tasks.Task<LoadBalancer> GetAsync(string resourceGroupName, string loadBalancerName, string api_version, string subscriptionId, string expand);
        ...
        /// <returns>Update successful. The operation returns the resulting LoadBalancer resource.</returns>

        System.Threading.Tasks.Task<LoadBalancer> CreateOrUpdateAsync(string resourceGroupName, string loadBalancerName, LoadBalancer parameters, string api_version, string subscriptionId);
        ...
        System.Threading.Tasks.Task<LoadBalancer> UpdateTagsAsync(string resourceGroupName, string loadBalancerName, TagsObject parameters, string api_version, string subscriptionId);
        ...
        /// <returns>Request successful. The operation returns a list of LoadBalancer resources.</returns>

        System.Threading.Tasks.Task<LoadBalancerListResult> ListAllAsync(string api_version, string subscriptionId);
        ...
        System.Threading.Tasks.Task<LoadBalancerListResult> ListAsync(string resourceGroupName, string api_version, string subscriptionId);
        ...
        System.Threading.Tasks.Task SwapPublicIpAddressesAsync(string location, LoadBalancerVipSwapRequest parameters, string api_version, string subscriptionId);
        ...
        /// <param name="parameters">Query inbound NAT rule port mapping request.</param>

        /// <param name="api_version">Client API version.</param>

        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>

        /// <returns>Successful request for query inbound NAT rule port mapping.</returns>

        System.Threading.Tasks.Task<BackendAddressInboundNatRulePortMappings> ListInboundNatRulePortMappingsAsync(string groupName, string loadBalancerName, string backendPoolName, QueryInboundNatRulePortMappingRequest parameters, string api_version, string subscriptionId);
        ...
        /// <param name="parameters">Parameters supplied to the migrateToIpBased Api.</param>

        /// <param name="api_version">Client API version.</param>

        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>

        /// <returns>Successful request for migrating Load balancer to IP Based.</returns>

        System.Threading.Tasks.Task<MigratedPools> MigrateToIpBasedAsync(string groupName, string loadBalancerName, MigrateLoadBalancerToIpBasedRequest parameters, string api_version, string subscriptionId);

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]

    public partial class LoadBalancersController : Microsoft.AspNetCore.Mvc.ControllerBase
    {
        private ILoadBalancersController _implementation;

        public LoadBalancersController(ILoadBalancersController implementation)
        {
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Delete successful.</returns>
        [Microsoft.AspNetCore.Mvc.HttpDelete, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}")]
        public System.Threading.Tasks.Task Delete(string resourceGroupName, string loadBalancerName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.DeleteAsync(resourceGroupName, loadBalancerName, api_version, subscriptionId);
        }
        ...
        /// <param name="expand">Expands referenced resources.</param>
        /// <returns>Request successful. The operation returns the resulting LoadBalancer resource.</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}")]
        public System.Threading.Tasks.Task<LoadBalancer> Get(string resourceGroupName, string loadBalancerName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "$expand")] string expand)
        {

            return _implementation.GetAsync(resourceGroupName, loadBalancerName, api_version, subscriptionId, expand);
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Update successful. The operation returns the resulting LoadBalancer resource.</returns>
        [Microsoft.AspNetCore.Mvc.HttpPut, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}")]
        public System.Threading.Tasks.Task<LoadBalancer> CreateOrUpdate(string resourceGroupName, string loadBalancerName, [Microsoft.AspNetCore.Mvc.FromBody] LoadBalancer parameters, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.CreateOrUpdateAsync(resourceGroupName, loadBalancerName, parameters, api_version, subscriptionId);
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Update successful. The operation returns the resulting LoadBalancer resource.</returns>
        [Microsoft.AspNetCore.Mvc.HttpPatch, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}")]
        public System.Threading.Tasks.Task<LoadBalancer> UpdateTags(string resourceGroupName, string loadBalancerName, [Microsoft.AspNetCore.Mvc.FromBody] TagsObject parameters, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.UpdateTagsAsync(resourceGroupName, loadBalancerName, parameters, api_version, subscriptionId);
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Request successful. The operation returns a list of LoadBalancer resources.</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/providers/Microsoft.Network/loadBalancers")]
        public System.Threading.Tasks.Task<LoadBalancerListResult> ListAll([Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Request successful. The operation returns a list of LoadBalancer resources.</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers")]
        public System.Threading.Tasks.Task<LoadBalancerListResult> List(string resourceGroupName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Request successful.</returns>
        [Microsoft.AspNetCore.Mvc.HttpPost, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/setLoadBalancerFrontendPublicIpAddresses")]
        public System.Threading.Tasks.Task SwapPublicIpAddresses(string location, [Microsoft.AspNetCore.Mvc.FromBody] LoadBalancerVipSwapRequest parameters, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.SwapPublicIpAddressesAsync(location, parameters, api_version, subscriptionId);
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Successful request for query inbound NAT rule port mapping.</returns>
        [Microsoft.AspNetCore.Mvc.HttpPost, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/backendAddressPools/{backendPoolName}/queryInboundNatRulePortMapping")]
        public System.Threading.Tasks.Task<BackendAddressInboundNatRulePortMappings> ListInboundNatRulePortMappings(string groupName, string loadBalancerName, string backendPoolName, [Microsoft.AspNetCore.Mvc.FromBody] QueryInboundNatRulePortMappingRequest parameters, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.ListInboundNatRulePortMappingsAsync(groupName, loadBalancerName, backendPoolName, parameters, api_version, subscriptionId);
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Successful request for migrating Load balancer to IP Based.</returns>
        [Microsoft.AspNetCore.Mvc.HttpPost, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/migrateToIpBased")]
        public System.Threading.Tasks.Task<MigratedPools> MigrateToIpBased(string groupName, string loadBalancerName, [Microsoft.AspNetCore.Mvc.FromBody] MigrateLoadBalancerToIpBasedRequest parameters, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.MigrateToIpBasedAsync(groupName, loadBalancerName, parameters, api_version, subscriptionId);
        }

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public interface ILoadBalancerBackendAddressPoolsController
    {
        ...
        /// <returns>Request successful. The operation returns a list of LoadBalancer BackendAddressPool resources.</returns>

        System.Threading.Tasks.Task<LoadBalancerBackendAddressPoolListResult> ListAsync(string resourceGroupName, string loadBalancerName, string api_version, string subscriptionId);
        ...
        /// <returns>Request successful. The operation returns LoadBalancer BackendAddressPool resource.</returns>

        System.Threading.Tasks.Task<BackendAddressPool> GetAsync(string resourceGroupName, string loadBalancerName, string backendAddressPoolName, string api_version, string subscriptionId);
        ...
        /// <returns>Update successful. The operation returns the resulting BackendAddressPool resource.</returns>

        System.Threading.Tasks.Task<BackendAddressPool> CreateOrUpdateAsync(string resourceGroupName, string loadBalancerName, string backendAddressPoolName, BackendAddressPool parameters, string api_version, string subscriptionId);
        ...
        System.Threading.Tasks.Task DeleteAsync(string resourceGroupName, string loadBalancerName, string backendAddressPoolName, string api_version, string subscriptionId);

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]

    public partial class LoadBalancerBackendAddressPoolsController : Microsoft.AspNetCore.Mvc.ControllerBase
    {
        private ILoadBalancerBackendAddressPoolsController _implementation;

        public LoadBalancerBackendAddressPoolsController(ILoadBalancerBackendAddressPoolsController implementation)
        {
            _implementation = implementation;
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Request successful. The operation returns a list of LoadBalancer BackendAddressPool resources.</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/backendAddressPools")]
        public System.Threading.Tasks.Task<LoadBalancerBackendAddressPoolListResult> List(string resourceGroupName, string loadBalancerName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.ListAsync(resourceGroupName, loadBalancerName, api_version, subscriptionId);
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Request successful. The operation returns LoadBalancer BackendAddressPool resource.</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/backendAddressPools/{backendAddressPoolName}")]
        public System.Threading.Tasks.Task<BackendAddressPool> Get(string resourceGroupName, string loadBalancerName, string backendAddressPoolName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.GetAsync(resourceGroupName, loadBalancerName, backendAddressPoolName, api_version, subscriptionId);
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Update successful. The operation returns the resulting BackendAddressPool resource.</returns>
        [Microsoft.AspNetCore.Mvc.HttpPut, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/backendAddressPools/{backendAddressPoolName}")]
        public System.Threading.Tasks.Task<BackendAddressPool> CreateOrUpdate(string resourceGroupName, string loadBalancerName, string backendAddressPoolName, [Microsoft.AspNetCore.Mvc.FromBody] BackendAddressPool parameters, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.CreateOrUpdateAsync(resourceGroupName, loadBalancerName, backendAddressPoolName, parameters, api_version, subscriptionId);
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Delete successful.</returns>
        [Microsoft.AspNetCore.Mvc.HttpDelete, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/backendAddressPools/{backendAddressPoolName}")]
        public System.Threading.Tasks.Task Delete(string resourceGroupName, string loadBalancerName, string backendAddressPoolName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.DeleteAsync(resourceGroupName, loadBalancerName, backendAddressPoolName, api_version, subscriptionId);
        }

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public interface ILoadBalancerFrontendIPConfigurationsController
    {
        ...
        /// <returns>Request successful. The operation returns a list of LoadBalancer FrontendIPConfiguration resources.</returns>

        System.Threading.Tasks.Task<LoadBalancerFrontendIPConfigurationListResult> ListAsync(string resourceGroupName, string loadBalancerName, string api_version, string subscriptionId);
        ...
        /// <returns>Request successful. The operation returns LoadBalancer FrontendIPConfiguration resource.</returns>

        System.Threading.Tasks.Task<FrontendIPConfiguration> GetAsync(string resourceGroupName, string loadBalancerName, string frontendIPConfigurationName, string api_version, string subscriptionId);

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]

    public partial class LoadBalancerFrontendIPConfigurationsController : Microsoft.AspNetCore.Mvc.ControllerBase
    {
        private ILoadBalancerFrontendIPConfigurationsController _implementation;

        public LoadBalancerFrontendIPConfigurationsController(ILoadBalancerFrontendIPConfigurationsController implementation)
        {
            _implementation = implementation;
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Request successful. The operation returns a list of LoadBalancer FrontendIPConfiguration resources.</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/frontendIPConfigurations")]
        public System.Threading.Tasks.Task<LoadBalancerFrontendIPConfigurationListResult> List(string resourceGroupName, string loadBalancerName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Request successful. The operation returns LoadBalancer FrontendIPConfiguration resource.</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/frontendIPConfigurations/{frontendIPConfigurationName}")]
        public System.Threading.Tasks.Task<FrontendIPConfiguration> Get(string resourceGroupName, string loadBalancerName, string frontendIPConfigurationName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.GetAsync(resourceGroupName, loadBalancerName, frontendIPConfigurationName, api_version, subscriptionId);
        }

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public interface IInboundNatRulesController
    {
        ...
        /// <returns>Request successful. The operation returns a list of LoadBalancer InboundNatRule resources.</returns>

        System.Threading.Tasks.Task<InboundNatRuleListResult> ListAsync(string resourceGroupName, string loadBalancerName, string api_version, string subscriptionId);
        ...
        System.Threading.Tasks.Task DeleteAsync(string resourceGroupName, string loadBalancerName, string inboundNatRuleName, string api_version, string subscriptionId);
        ...
        /// <returns>Request successful. The operation returns the resulting InboundNatRule resource.</returns>

        System.Threading.Tasks.Task<InboundNatRule> GetAsync(string resourceGroupName, string loadBalancerName, string inboundNatRuleName, string api_version, string subscriptionId, string expand);
        ...
        /// <returns>Update successful. The operation returns the resulting InboundNatRule resource.</returns>

        System.Threading.Tasks.Task<InboundNatRule> CreateOrUpdateAsync(string resourceGroupName, string loadBalancerName, string inboundNatRuleName, InboundNatRule inboundNatRuleParameters, string api_version, string subscriptionId);

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]

    public partial class InboundNatRulesController : Microsoft.AspNetCore.Mvc.ControllerBase
    {
        private IInboundNatRulesController _implementation;

        public InboundNatRulesController(IInboundNatRulesController implementation)
        {
            _implementation = implementation;
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Request successful. The operation returns a list of LoadBalancer InboundNatRule resources.</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/inboundNatRules")]
        public System.Threading.Tasks.Task<InboundNatRuleListResult> List(string resourceGroupName, string loadBalancerName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Delete successful.</returns>
        [Microsoft.AspNetCore.Mvc.HttpDelete, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/inboundNatRules/{inboundNatRuleName}")]
        public System.Threading.Tasks.Task Delete(string resourceGroupName, string loadBalancerName, string inboundNatRuleName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.DeleteAsync(resourceGroupName, loadBalancerName, inboundNatRuleName, api_version, subscriptionId);
        }
        ...
        /// <param name="expand">Expands referenced resources.</param>
        /// <returns>Request successful. The operation returns the resulting InboundNatRule resource.</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/inboundNatRules/{inboundNatRuleName}")]
        public System.Threading.Tasks.Task<InboundNatRule> Get(string resourceGroupName, string loadBalancerName, string inboundNatRuleName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "$expand")] string expand)
        {

            return _implementation.GetAsync(resourceGroupName, loadBalancerName, inboundNatRuleName, api_version, subscriptionId, expand);
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Update successful. The operation returns the resulting InboundNatRule resource.</returns>
        [Microsoft.AspNetCore.Mvc.HttpPut, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/inboundNatRules/{inboundNatRuleName}")]
        public System.Threading.Tasks.Task<InboundNatRule> CreateOrUpdate(string resourceGroupName, string loadBalancerName, string inboundNatRuleName, [Microsoft.AspNetCore.Mvc.FromBody] InboundNatRule inboundNatRuleParameters, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.CreateOrUpdateAsync(resourceGroupName, loadBalancerName, inboundNatRuleName, inboundNatRuleParameters, api_version, subscriptionId);
        }

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public interface ILoadBalancerLoadBalancingRulesController
    {
        ...
        /// <returns>Request successful. The operation returns a list of LoadBalancer LoadBalancingRule resources.</returns>

        System.Threading.Tasks.Task<LoadBalancerLoadBalancingRuleListResult> ListAsync(string resourceGroupName, string loadBalancerName, string api_version, string subscriptionId);
        ...
        /// <returns>Request successful. The operation returns the resulting LoadBalancingRule resource.</returns>

        System.Threading.Tasks.Task<LoadBalancingRule> GetAsync(string resourceGroupName, string loadBalancerName, string loadBalancingRuleName, string api_version, string subscriptionId);
        ...
        /// <returns>Successful request for query load balancer health per rule.</returns>

        System.Threading.Tasks.Task<LoadBalancerHealthPerRule> HealthAsync(string groupName, string loadBalancerName, string loadBalancingRuleName, string api_version, string subscriptionId);

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]

    public partial class LoadBalancerLoadBalancingRulesController : Microsoft.AspNetCore.Mvc.ControllerBase
    {
        private ILoadBalancerLoadBalancingRulesController _implementation;

        public LoadBalancerLoadBalancingRulesController(ILoadBalancerLoadBalancingRulesController implementation)
        {
            _implementation = implementation;
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Request successful. The operation returns a list of LoadBalancer LoadBalancingRule resources.</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/loadBalancingRules")]
        public System.Threading.Tasks.Task<LoadBalancerLoadBalancingRuleListResult> List(string resourceGroupName, string loadBalancerName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Request successful. The operation returns the resulting LoadBalancingRule resource.</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/loadBalancingRules/{loadBalancingRuleName}")]
        public System.Threading.Tasks.Task<LoadBalancingRule> Get(string resourceGroupName, string loadBalancerName, string loadBalancingRuleName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.GetAsync(resourceGroupName, loadBalancerName, loadBalancingRuleName, api_version, subscriptionId);
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Successful request for query load balancer health per rule.</returns>
        [Microsoft.AspNetCore.Mvc.HttpPost, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/loadBalancingRules/{loadBalancingRuleName}/health")]
        public System.Threading.Tasks.Task<LoadBalancerHealthPerRule> Health(string groupName, string loadBalancerName, string loadBalancingRuleName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.HealthAsync(groupName, loadBalancerName, loadBalancingRuleName, api_version, subscriptionId);
        }

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public interface ILoadBalancerOutboundRulesController
    {
        ...
        /// <returns>Request successful. The operation returns a list of LoadBalancer OutboundRule resources.</returns>

        System.Threading.Tasks.Task<LoadBalancerOutboundRuleListResult> ListAsync(string resourceGroupName, string loadBalancerName, string api_version, string subscriptionId);
        ...
        /// <returns>Request successful. The operation returns the resulting OutboundRule resource.</returns>

        System.Threading.Tasks.Task<OutboundRule> GetAsync(string resourceGroupName, string loadBalancerName, string outboundRuleName, string api_version, string subscriptionId);

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]

    public partial class LoadBalancerOutboundRulesController : Microsoft.AspNetCore.Mvc.ControllerBase
    {
        private ILoadBalancerOutboundRulesController _implementation;

        public LoadBalancerOutboundRulesController(ILoadBalancerOutboundRulesController implementation)
        {
            _implementation = implementation;
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Request successful. The operation returns a list of LoadBalancer OutboundRule resources.</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/outboundRules")]
        public System.Threading.Tasks.Task<LoadBalancerOutboundRuleListResult> List(string resourceGroupName, string loadBalancerName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Request successful. The operation returns the resulting OutboundRule resource.</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/outboundRules/{outboundRuleName}")]
        public System.Threading.Tasks.Task<OutboundRule> Get(string resourceGroupName, string loadBalancerName, string outboundRuleName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.GetAsync(resourceGroupName, loadBalancerName, outboundRuleName, api_version, subscriptionId);
        }

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public interface ILoadBalancerNetworkInterfacesController
    {
        ...
        /// <returns>Request successful. The operation returns a list of NetworkInterface resources.</returns>

        System.Threading.Tasks.Task<NetworkInterfaceListResult> ListAsync(string resourceGroupName, string loadBalancerName, string api_version, string subscriptionId);

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]

    public partial class LoadBalancerNetworkInterfacesController : Microsoft.AspNetCore.Mvc.ControllerBase
    {
        private ILoadBalancerNetworkInterfacesController _implementation;

        public LoadBalancerNetworkInterfacesController(ILoadBalancerNetworkInterfacesController implementation)
        {
            _implementation = implementation;
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Request successful. The operation returns a list of NetworkInterface resources.</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/networkInterfaces")]
        public System.Threading.Tasks.Task<NetworkInterfaceListResult> List(string resourceGroupName, string loadBalancerName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public interface ILoadBalancerProbesController
    {
        ...
        /// <returns>Request successful. The operation returns a list of LoadBalancer Probe resources.</returns>

        System.Threading.Tasks.Task<LoadBalancerProbeListResult> ListAsync(string resourceGroupName, string loadBalancerName, string api_version, string subscriptionId);
        ...
        /// <returns>Request successful. The operation returns LoadBalancer Probe resource.</returns>

        System.Threading.Tasks.Task<Probe> GetAsync(string resourceGroupName, string loadBalancerName, string probeName, string api_version, string subscriptionId);

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]

    public partial class LoadBalancerProbesController : Microsoft.AspNetCore.Mvc.ControllerBase
    {
        private ILoadBalancerProbesController _implementation;

        public LoadBalancerProbesController(ILoadBalancerProbesController implementation)
        {
            _implementation = implementation;
        }
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Request successful. The operation returns a list of LoadBalancer Probe resources.</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/probes")]
        public System.Threading.Tasks.Task<LoadBalancerProbeListResult> List(string resourceGroupName, string loadBalancerName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {
        ...
        /// <param name="subscriptionId">The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.</param>
        /// <returns>Request successful. The operation returns LoadBalancer Probe resource.</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/probes/{probeName}")]
        public System.Threading.Tasks.Task<Probe> Get(string resourceGroupName, string loadBalancerName, string probeName, [Microsoft.AspNetCore.Mvc.FromQuery(Name = "api-version")] string api_version, string subscriptionId)
        {

            return _implementation.GetAsync(resourceGroupName, loadBalancerName, probeName, api_version, subscriptionId);
        }
    ...
    public partial class GatewayLoadBalancerTunnelInterface
    {
        ...
        public GatewayLoadBalancerTunnelInterfaceProtocol? Protocol { get; set; }
    ...
    public partial class LoadBalancerBackendAddressPropertiesFormat
    {
        ...
        public System.Collections.Generic.List<NatRulePortMapping> InboundNatRulesPortMapping { get; set; }
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public LoadBalancerBackendAddressPropertiesFormatAdminState? AdminState { get; set; }
    ...
    public partial class BackendAddressPoolPropertiesFormat
    {
        ...
        public System.Collections.Generic.List<GatewayLoadBalancerTunnelInterface> TunnelInterfaces { get; set; }
        ...
        public System.Collections.Generic.List<LoadBalancerBackendAddress> LoadBalancerBackendAddresses { get; set; }
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public BackendAddressPoolPropertiesFormatSyncMode? SyncMode { get; set; }
    ...
    public partial class LoadBalancingRulePropertiesFormat
    {
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public LoadBalancingRulePropertiesFormatLoadDistribution? LoadDistribution { get; set; }
    ...
    public partial class ProbePropertiesFormat
    {
        ...
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public ProbePropertiesFormatProtocol Protocol { get; set; }
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public ProbePropertiesFormatNoHealthyBackendsBehavior? NoHealthyBackendsBehavior { get; set; }
    ...
    public partial class LoadBalancerPropertiesFormat
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("loadBalancingRules", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<LoadBalancingRule> LoadBalancingRules { get; set; }
        ...
        public System.Collections.Generic.List<Probe> Probes { get; set; }
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("inboundNatPools", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<InboundNatPool> InboundNatPools { get; set; }

        /// <summary>
        /// The outbound rules.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("outboundRules", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<OutboundRule> OutboundRules { get; set; }
    ...
    public partial class LoadBalancerListResult
    {
        ...
        public System.Collections.Generic.List<LoadBalancer> Value { get; set; }
    ...
    public partial class InboundNatRuleListResult
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("value", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<InboundNatRule> Value { get; set; }
    ...
    public partial class LoadBalancerBackendAddressPoolListResult
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("value", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<BackendAddressPool> Value { get; set; }
    ...
    public partial class LoadBalancerFrontendIPConfigurationListResult
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("value", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<FrontendIPConfiguration> Value { get; set; }
    ...
    public partial class LoadBalancerLoadBalancingRuleListResult
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("value", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<LoadBalancingRule> Value { get; set; }
    ...
    public partial class LoadBalancerOutboundRuleListResult
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("value", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<OutboundRule> Value { get; set; }
    ...
    public partial class LoadBalancerProbeListResult
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("value", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<Probe> Value { get; set; }
    ...
    public partial class LoadBalancerVipSwapRequest
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("frontendIPConfigurations", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<LoadBalancerVipSwapRequestFrontendIPConfiguration> FrontendIPConfigurations { get; set; }
    ...
    public partial class LoadBalancerVipSwapRequestFrontendIPConfiguration
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("properties", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public LoadBalancerVipSwapRequestFrontendIPConfigurationProperties Properties { get; set; }
    ...
    public partial class BackendAddressInboundNatRulePortMappings
    {
        ...
        /// Collection of inbound NAT rule port mappings.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("inboundNatRulePortMappings", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<InboundNatRulePortMapping> InboundNatRulePortMappings { get; set; }
    ...
    public partial class LoadBalancerHealthPerRule
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("loadBalancerBackendAddresses", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<LoadBalancerHealthPerRulePerBackendAddress> LoadBalancerBackendAddresses { get; set; }
    ...
    public partial class LoadBalancerHealthPerRulePerBackendAddress
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("networkInterfaceIPConfigurationId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class MigrateLoadBalancerToIpBasedRequest
    {
        ...
        public System.Collections.Generic.List<string> Pools { get; set; }
    ...
    public partial class MigratedPools
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("migratedPools", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<string> MigratedPools1 { get; set; }
    ...
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class FrontendIPConfiguration2 : SubResource
    {
        /// <summary>
        /// Properties of the load balancer probe.
        /// </summary>
    ...
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class BackendAddressPool2 : SubResource
    {
        /// <summary>
        /// Properties of load balancer backend address pool.
        /// </summary>
    ...
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class InboundNatRule2 : SubResource
    {
        /// <summary>
        /// Properties of load balancer inbound NAT rule.
        /// </summary>
    ...
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class LoadBalancer2 : Resource
    {
        /// <summary>
        /// The extended location of the load balancer.
        /// </summary>
    ...
    public partial class NetworkInterfaceListResult
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("value", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<NetworkInterface> Value { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum GatewayLoadBalancerTunnelInterfaceProtocol
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum LoadBalancerBackendAddressPropertiesFormatAdminState
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum BackendAddressPoolPropertiesFormatSyncMode
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum LoadBalancingRulePropertiesFormatLoadDistribution
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum ProbePropertiesFormatProtocol
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum ProbePropertiesFormatNoHealthyBackendsBehavior
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum OutboundRulePropertiesFormatProtocol
    {
    ...
    public partial class Properties2
    {
        ...
        public System.Collections.Generic.List<BackendAddressPool2> LoadBalancerBackendAddressPools { get; set; }
        ...
        public System.Collections.Generic.List<InboundNatRule2> LoadBalancerInboundNatRules { get; set; }
    ...
    public partial class Properties5
    {
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public Properties5PrivateEndpointNetworkPolicies? PrivateEndpointNetworkPolicies { get; set; } = LoadBalancerController.Properties5PrivateEndpointNetworkPolicies.Disabled;
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public Properties5PrivateLinkServiceNetworkPolicies? PrivateLinkServiceNetworkPolicies { get; set; } = LoadBalancerController.Properties5PrivateLinkServiceNetworkPolicies.Enabled;
    ...
    public partial class Properties13
    {
        ...
        [Newtonsoft.Json.JsonProperty("privateIPAllocationMethod", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public IPAllocationMethod? PrivateIPAllocationMethod { get; set; } = LoadBalancerController.IPAllocationMethod.Dynamic;
    ...
    public partial class Properties18
    {
        ...
        public FrontendIPConfiguration2 DestinationLoadBalancerFrontEndIPConfiguration { get; set; }
    ...
    public partial class Properties22
    {
        ...
        public System.Collections.Generic.List<FrontendIPConfiguration2> LoadBalancerFrontendIpConfigurations { get; set; }
    ...
    public partial class Properties23
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("frontendIPConfigurations", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<FrontendIPConfiguration2> FrontendIPConfigurations { get; set; }

        /// <summary>
        /// Collection of backend address pools used by a load balancer.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("backendAddressPools", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<BackendAddressPool2> BackendAddressPools { get; set; }
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("inboundNatRules", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<InboundNatRule2> InboundNatRules { get; set; }
